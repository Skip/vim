...
syn match	cUserCont	display "^\s*\I\i*\s*:$" contains=@cLabelGroup,cDelimiter,cStatement
syn match	cUserCont	display ";\s*\I\i*\s*:$" contains=@cLabelGroup,cDelimiter
syn match	cUserCont	display "^\s*\I\i*\s*:[^:]"me=e-1 contains=@cLabelGroup,cDelimiter,cStatement
syn match	cUserCont	display ";\s*\I\i*\s*:[^:]"me=e-1 contains=@cLabelGroup,cDelimiter
